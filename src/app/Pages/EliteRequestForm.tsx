...
export default function EliteRequestForm() {
    ...
    return (
        <div className="container mt-6 px-18 bg-white" dir={isArabic ? "rtl" : "ltr"}>
            <h4 className="text-center mb-6 text-xl font-semibold">ELITE REQUEST FORM</h4>
                ...
                <form onSubmit={handleSubmit(onSubmit)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div className=" relative">
                                <select {...register("nationality", { required: true })} className="form-control">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <input type="number" placeholder="From" {...register("ageFrom")} className="form-control " />
                                <input type="number" placeholder="To" {...register("ageTo")} className="form-control " />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className=" p-4 mb-6 ">
                        ...
                        <p className="text-lg ">
                            Please be assured that any information you provide to us will be treated with the utmost confidentiality. We are
